 ...
 */
  ...
  #define L2_MEM_H_BASE_ADDR (PULP_H_BASE_ADDR - ARCHI_CLUSTER_GLOBAL_ADDR(0) + L2_MEM_BASE_ADDR)
  ...
  #define MBOX_H_BASE_ADDR \
    (PULP_H_BASE_ADDR - ARCHI_CLUSTER_GLOBAL_ADDR(0) + MAILBOX_BASE_ADDR - MBOX_SIZE_B) // Interface 0
  #define SOC_PERIPHERALS_H_BASE_ADDR \
    (PULP_H_BASE_ADDR - ARCHI_CLUSTER_GLOBAL_ADDR(0) + ARCHI_SOC_PERIPHERALS_ADDR)
...
#define TIMER_H_OFFSET_B     (ARCHI_TIMER_ADDR - ARCHI_CLUSTER_ADDR)
