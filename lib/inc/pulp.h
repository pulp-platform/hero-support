...
#define PULP_P_BASE_ADDR 0x20000000 // Address at which PULP sees itself
#define CLUSTER_SIZE_MB 4
#define N_CLUSTERS 1
#define L2_MEM_SIZE_KB 64
#define L2_MEM_OFFSET_B 0xC000000
#define PERIPHERALS_OFFSET_B 0xA000000
#define PERIPHERALS_SIZE_B 0x10000

#elif BOARD == ZC706

// L3
#define L3_MEM_SIZE_MB 256
...
#define RAB_CONFIG_BASE_ADDR 0x84000000
...
#define L2_MEM_H_BASE_ADDR (PULP_H_BASE_ADDR + L2_MEM_OFFSET_B)
#define PERIPHERALS_H_BASE_ADDR (PULP_H_BASE_ADDR + PERIPHERALS_OFFSET_B)
#define CLUSTERS_H_BASE_ADDR (PULP_H_BASE_ADDR)
#define CLUSTERS_SIZE_B (N_CLUSTERS*CLUSTER_SIZE_MB*1024*1024)

#define DEMUX_CONFIG_OFFSET_B (DEMUX_CONFIG_BASE_ADDR - CONFIG_BASE_ADDR)
#define RAB_CONFIG_OFFSET_B (RAB_CONFIG_BASE_ADDR - CONFIG_BASE_ADDR)
